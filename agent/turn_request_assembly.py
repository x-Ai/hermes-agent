...
def assemble_api_request(
    ...
    # Preserve the independent rough wire estimate before an exact usage anchor
    # replaces it. Compatibility gateways can use this to disambiguate whether
    # Anthropic-style cache fields are disjoint buckets or subsets of input.
    agent._current_request_prompt_tokens_hint = request_pressure_tokens
