...
def _resolve_gateway_model_context(model: Optional[str] = None) -> _GatewayModelContext:
    ...
    def _read_runtime() -> None:
        ...
        requested_provider = runtime.get("requested_provider") or runtime.get("provider") or provider or ""
    ...
    context_length = get_model_context_length(
        ...
        custom_providers=custom_providers, requested_provider=requested_provider or provider or "")
