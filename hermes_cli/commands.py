...
def _collect_gateway_skill_entries(
    ...
    try:
        ...
        # Build set of allowed roots: local skills dir + any
        # user-configured ``skills.external_dirs`` + trusted project dirs.
        # Resolve and compare path components so Windows separators and prefix
        # lookalikes (``my-skills-extra``) cannot bypass the boundary.
