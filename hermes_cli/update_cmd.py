...
def _update_via_zip(args, *, had_desktop_app_before_update: bool = False) -> bool:
    ...
    zip_url = (
        f"https://github.com/x-Ai/hermes-agent/archive/refs/heads/{branch}.zip"
    )
...
OFFICIAL_REPO_URLS = {
    "https://github.com/x-Ai/hermes-agent.git",
    "git@github.com:x-Ai/hermes-agent.git",
    "https://github.com/x-Ai/hermes-agent",
    "git@github.com:x-Ai/hermes-agent",
}

OFFICIAL_REPO_URL = "https://github.com/x-Ai/hermes-agent.git"
...
def _sync_with_upstream_if_needed(
    ...
    *,
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from x-Ai/hermes-agent.")
        print()
        ...
        if response in {"", "y", "yes"}:
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print(
                    "  ✓ Added upstream: https://github.com/x-Ai/hermes-agent.git"
                )
                has_upstream = True
            else:
            ...
            print(
                "  Skipped. Run 'git remote add upstream https://github.com/x-Ai/hermes-agent.git' to add later."
            )
