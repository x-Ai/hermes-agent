...
DEFAULT_CONFIG = {
    ...
    "delegation": {
        ...
        "provider": "",  # built-in name or custom endpoint id (empty = inherit parent provider + credentials)
        # Desktop suggestions for configured custom endpoints and their discovered model catalogs.
        # Both provider/model stay free-input; this only controls the optional datalist affordance.
