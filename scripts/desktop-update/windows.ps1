...
try {
    ...
    # Electron starts this hand-off in HERMES_HOME, whose hermes-agent child is
    # the actual checkout. Pass the canonical install root explicitly: cwd is
    # launcher state, not install identity.
