...
from tools.delegate_tool_progress import (  # noqa: F401
    ...
    _build_child_system_prompt, _clean_error_text, _emit_parent_console, _quiet,
    _resolve_host_workspace_hint, _resolve_workspace_hint,
...
def _build_child_agent(
    ...
    host_workspace_path = _resolve_host_workspace_hint(parent_agent)
    child_prompt = _build_child_system_prompt(
        goal, context,
        workspace_path=_resolve_workspace_hint(parent_agent),
        context_workspace_path=host_workspace_path,
        role=effective_role,
