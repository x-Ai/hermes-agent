...
_CONTAINER_CONFIG_DEFAULTS = (
    ...
    ("docker_mount_cwd_to_workspace", False), ("singularity_mount_cwd_to_workspace", False),
...
def _get_or_create_env(task_id: str):
    ...
    from tools.terminal_tool import (
        ...
        _resolve_workspace_mount_for_task, _is_container_backend, _select_image,
    ...
    with task_lock:
        ...
        env = _create_environment(
            ...
            host_cwd=(
                ...
                else _resolve_task_host_cwd(config, task_id)
            ),
        )
        with _env_lock:
