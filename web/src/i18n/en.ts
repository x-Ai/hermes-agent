...
export const en: Translations = {
  ...
  skills: {
    wisdom: {
      reviewUi: {
        notifications: 'Collective Wisdom notifications',
        ...
        status: 'Status',
        details: 'Details',
        noKnownMatches: 'No known matches detected',
        findings: count => `${count} finding${count === 1 ? '' : 's'}`,
        professionalismLabels: {
        ...
        statusLabels: {
          pass: 'Pass', blocked: 'Blocked', pending: 'Pending', retry: 'Retry',
          running: 'Running', advisory: 'Advisory', unavailable: 'Unavailable'
        },
        securityCheck: 'Security check',
        securityLocalPreflight: 'Security check (local preflight)',
        securityLocalNote: 'Local checks complete. Required Gateway checks run after you confirm upload and before publication.',
        securityGatewayNote: 'Deterministic Gateway scan. A pass means no known matches were detected, not that the package is certified secure.',
        professionalismCheck: 'Professionalism check',
        professionalismNote: 'Agent-assessed and advisory. It does not block publication or installation.',
        source: 'Source',
        preview: 'Preview',
        localDraft: 'local draft',
        serverReviewed: 'server-reviewed',
        editorMode: path => `${path} editor mode`,
        editFile: path => `Edit ${path}`,
        addItem: item => `Add ${item}`,
        removeItem: (item, index) => `Remove ${item} ${index}`,
        other: label => `Other ${label.toLowerCase()}`,
        unlistedTargetHint: 'Keep this empty unless the skill targets a platform not listed above.',
        toolName: 'Tool name',
        minimumVersionOptional: 'Minimum version (optional)',
        adminRequired: 'Administrator permission required',
        adminRequiredDescription: "Installing or enabling this tool needs an administrator's action.",
        autoInstallOff: 'Automatic installation is always off.',
        remove: 'Remove',
        addTool: 'Add tool',
        pluginId: 'Plugin ID',
        required: 'Required',
        requiredPluginDescription: 'Without this plugin, the skill cannot provide its complete behavior.',
        addPlugin: 'Add plugin',
        compatibilityIntro: 'Hermes pre-fills new drafts from this authoring device and requirements explicitly recorded on the skill. Review these values before sharing: selected platforms and architectures restrict where teammates can install the skill. Clear every selection only when the skill is known to work everywhere.',
        compatibilityTargets: 'Compatibility targets',
        minimumHermesVersion: 'Minimum Hermes version',
        olderHermesBlocked: 'Older Hermes installations will be blocked.',
        minimumContextWindow: 'Minimum model context window',
        noMinimum: 'Leave blank when no minimum is required.',
        platforms: 'Platforms',
        platformsDescription: 'Checked systems are the allowed install targets. New drafts start with this authoring system.',
        architectures: 'Architectures',
        architecturesDescription: 'Checked processors are the allowed install targets. New drafts start with this device.',
        modelCapabilities: 'Model capabilities',
        modelCapabilitiesDescription: 'Capabilities the active model must provide, such as vision or tool use.',
        modelCapability: 'model capability',
        hardware: 'Hardware',
        hardwareDescription: 'Physical hardware requirements, such as a GPU.',
        hardwareRequirement: 'hardware requirement',
        runtimeAccess: 'Runtime access',
        runtimeAccessDescription: 'These requirements are checked locally before installation. They do not grant permissions by themselves.',
        shellCommands: 'Shell commands',
        shellCommandsDescription: 'The skill needs to run terminal commands.',
        browserControl: 'Browser control',
        browserControlDescription: 'The skill needs an interactive browser.',
        codeExecution: 'Code execution',
        codeExecutionDescription: 'The skill needs a code-execution environment.',
        sandboxRequired: 'Sandbox required',
        sandboxRequiredDescription: 'The skill must run with sandbox isolation enabled.',
        toolsAndPlugins: 'Tools and plugins',
        tools: 'Tools',
        toolsDescription: 'Hermes pre-fills explicit skill requirements and checks whether they are enabled. This manifest can never install them automatically.',
        plugins: 'Plugins',
        pluginsDescription: 'Hermes pre-fills explicitly declared plugin IDs. Confirm whether each is required.',
        credentialsAndConnections: 'Credentials and connections',
        credentials: 'Credentials',
        credentialsDescription: 'Names only. Secret values are never included in the manifest.',
        credential: 'credential',
        connections: 'Connections',
        connectionsDescription: 'Configured services or linked accounts the skill needs.',
        connection: 'connection',
        dataAccess: 'Data access',
        filesystemRead: 'Filesystem read access',
        filesystemReadDescription: 'Paths the skill needs to read.',
        readPath: 'read path',
        filesystemWrite: 'Filesystem write access',
        filesystemWriteDescription: 'Paths the skill needs to modify.',
        writePath: 'write path',
        networkDestinations: 'Network destinations',
        networkDestinationsDescription: 'Hosts or services the skill needs to contact.',
        networkDestination: 'network destination',
        knownLimitations: 'Known limitations',
        knownLimitationsDescription: 'Important constraints teammates should understand before installation.',
        knownLimitation: 'known limitation',
        formUnavailable: 'This server-reviewed manifest cannot be safely represented as a form. Reload the draft and try again.',
        skillIdentity: 'Skill identity',
        skillName: 'Skill name',
        skillNameDescription: 'The package name recorded in the manifest.',
        schemaVersion: 'Schema version',
        schemaVersionDescription: 'Fixed by the V1 contract.',
        verifiedPlan: 'Verified managed action plan',
        managedCurrent: 'This managed skill is already current.',
        viewInPortal: 'View in Portal',
        ownerReviewExact: 'Owner review exact content',
        ownerDescriptionUnverified: 'Owner-authored description (not platform verified)',
        editOwnerDescription: 'Edit owner-authored description',
        serverChecks: 'Server-enforced scan and server-derived facts',
        systemSpecDeclarative: 'System Specification (declarative only)',
        contentHash: 'content',
        authorDescriptionHash: 'author description',
        packageManifestHash: 'package manifest',
        publicationOpen: 'Confirming uploads this exact package and publishes it to your team after the required checks.',
        publicationModerated: 'Confirming uploads this exact package for your organization to approve. It stays unpublished until moderation is complete.',
        publishToTeam: 'Publish to team',
        submitForApproval: 'Submit for approval',
        actionTimedOut: 'Collective Wisdom action timed out',
        actionFailed: code => `Collective Wisdom action failed (${code})`,
        fixSystemSpecification: 'Fix the System Specification before saving: {error}',
        manifestRequired: 'The complete package must include skill.manifest.json.',
        unknownSkill: 'A Collective Wisdom skill'
      },
