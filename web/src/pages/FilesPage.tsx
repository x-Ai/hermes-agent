...
export default function FilesPage() {
  ...
  const createDirectory = async () => {
    ...
    try {
      ...
      showToast(`${copy.createFailed}: ${errorMessage(e)}`, "error");
    } finally {
      setCreating(false);
    }
  };
  ...
  const uploadFiles = async (files: FileList | null) => {
    ...
    try {
      ...
      showToast(`${copy.uploadFailed}: ${errorMessage(e)}`, "error");
    } finally {
      setUploading(false);
  ...
  const downloadFile = async (entry: ManagedFileEntry) => {
    ...
    try {
      ...
      showToast(`${copy.downloadFailed}: ${errorMessage(e)}`, "error");
    }
  };
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      showToast(`${copy.deleteFailed}: ${errorMessage(e)}`, "error");
    } finally {
      setDeleting(false);
    }
  };
