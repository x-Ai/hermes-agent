...
export const zh = defineCompleteLocale({
  connectors: {
    title: '连接你的应用',
    connect: '连接',
    skip: '暂不连接',
  ...
  boot: {
    ...
    steps: {
      ...
      backendReady: 'Hermes 后端已就绪',
      connectingRemoteBackend: '正在连接到远程 Hermes 后端',
      resolvingBackend: '解析 Hermes 后端',
      resolvingRuntime: '解析 Hermes 运行时',
      restartingAfterUpdate: '正在重启 Hermes 以完成更新…',
      runtimeReady: 'Hermes 运行时已就绪',
      startingBackend: '正在启动 Hermes 后端',
  ...
  notifications: {
    ...
    seeWhatsNew: '查看更新内容',
    toast: {
      artifactPartialLoad: (failed, total) => `索引产物时，已跳过最近 ${total} 个会话中的 ${failed} 个`,
      artifactSafeLimitExceeded: count => `${count} 个会话超出安全记录加载限制`,
      artifactUnreadable: count => `${count} 个会话无法读取`,
      attachmentLimitSaveFailed: '无法保存附件大小上限',
      localEndpointSaveFailed: '无法保存本地端点',
      memoryConnectionStartFailed: '无法启动连接',
      memoryFieldSaveFailed: label => `无法保存 ${label}`,
      memoryProviderSavedMessage: '记忆提供方配置已更新',
      memoryProviderSavedTitle: label => `${label} 已保存`,
      memoryProviderSettingsSaveFailed: label => `无法保存 ${label} 设置`,
      modelChangeFailed: '无法更改模型',
      onboardingReadyTitle: 'Hermes 已就绪',
      openBrowserWindowFailed: '无法将浏览器弹出到新窗口',
      openNewWindowFailed: '无法打开新窗口',
      openSessionTerminalFailed: '无法在终端中打开聊天',
      openSessionWindowFailed: '无法在新窗口中打开聊天',
      petDraftsReadyMessage: '你的宠物草稿已完成，请选择一个进行孵化',
      petDraftsReadyTitle: '宠物草稿已就绪',
      petGenerationFailedTitle: '宠物生成失败',
      petHatchedMessage: '重新打开以命名并领养它',
      petHatchedTitle: '你的宠物已孵化',
      petHatchingFailedTitle: '孵化失败',
      petReopenTryAgain: '请重新打开后重试',
      pluginLoadFailed: origin => `插件"${origin}"加载失败`,
      pluginRegisterFailed: name => `插件"${name}"注册失败`,
      pluginsFolderOpenFailed: '无法打开插件文件夹',
      pluginsFolderResolveFailed: '无法确定插件文件夹位置',
      pluginsFolderUnavailable: '桌面插件不可用',
      pluginsHomeUnavailable: '后端未报告其主目录',
      gatewayConnectFailed: '无法连接到 Hermes 网关',
      processStopFailed: '无法停止进程',
      providerConnected: provider => `${provider} 已连接`,
      providerSaveFailed: label => `无法保存 ${label}`,
      reactionFailed: '无法添加回应',
      runtimeNotReadyMessage: 'Hermes 桌面版启动时无法验证正在运行的后端，在网关恢复连接前，部分功能可能不可用',
      runtimeNotReadyTitle: '运行环境尚未就绪',
      toolGatewayEnabledMessage: labels => `${labels.join('、')} 现在通过你的 Nous 订阅运行，无需单独的 API key`,
      toolGatewayEnabledTitle: '工具网关已启用',
      toolGatewayTools: {
        browser: '浏览器自动化',
        image_gen: '图像生成',
        tts: '文字转语音',
  ...
  billingPage: {
    ...
    freeTierNoticeTitle: '你正在使用 Nous 免费套餐',
    openPortalArrow: '打开门户 ↗',
    customCreditAmount: '自定义充值金额',
    buy: '购买',
    processingSettlement: '处理中…正在确认结算',
    creditsAdded: amount => `已添加 ${amount}，正在刷新余额`,
    creditsAddedShort: amount => `${amount} added`,
    creditsAddedTitle: '学分已添加',
    usageFallback: label => `${label}用量`,
    invoices: '账单记录',
    preview: '预览',
    previewFixture: '账单预览测试数据（仅开发模式）',
    live: '实时',
    ...
    autoRefillOff: '自动充值已关闭',
    threshold: '触发阈值',
    reloadTo: '充值至',
    autoRefillThresholdLabel: '自动充值阈值',
    autoRefillReloadToLabel: '自动充值目标金额',
    ...
    undo: '撤销',
    addCardArrow: '添加银行卡 ↗',
    noPaymentMethodTitle: '尚未添加付款方式',
    noCardBody: '添加银行卡前，购买充值额度和自动充值将保持禁用，请前往门户添加银行卡',
    enabled: '已启用',
    subscriptionUnavailable: '暂时无法获取订阅详情，但仍可打开门户',
    ...
    paymentMethod: '付款方式',
    manageCardDescription: '管理用于充值和订阅续费的银行卡',
    cardSourceAutoRefill: '自动充值银行卡',
    cardSourceCustomerDefault: '客户默认银行卡',
    cardSourceSubscription: '订阅银行卡',
    buyCreditsNow: '立即购买额度',
    singleChargeDescription: '从银行卡一次性扣款，并立即加入余额',
    autoRefillDescription: '余额低于阈值时自动补充余额',
    manageAutoRefillPortal: '请前往门户管理自动充值',
    ...
    creditsOver: (remaining, total, over) => `剩余 ${remaining}，共 ${total} · 超出 ${over}`,
    subscriptionCreditsRemaining: '剩余订阅额度',
    resetsOn: date => `重置日期：${date}`,
    subscriptionCredits: '订阅额度',
    doesNotExpire: '永不过期',
    topUpCredits: '充值额度',
    monthlySpendCapUsed: '已用月度消费上限',
    ...
    refusal: {
      ...
      scopeTitle: '远程消费需要授权',
      scopeMessage: '需要允许远程消费，请先发起一次充值以完成授权，然后重试',
      revokedTitle: '远程消费已停止',
      revokedByAdmin: '管理员已停止此终端的远程消费',
      revokedByUser: '你已停止此终端的远程消费',
      revokedReconnect: actor => `${actor}请在"设置 → 网关"中重新连接，以重新授权此设备`,
      ...
      freshTopUpMessage: '🔴 此扣款键已用于其他金额，请重新发起充值',
      noSavedCardTitle: '没有已保存的银行卡',
      noSavedCardMessage: '💳 尚未保存用于终端扣款的银行卡，请在门户设置（一次性购买额度不会保存银行卡）',
      ...
      timeoutTitle: '计费请求超时',
      timeoutMessage: '计费请求已超时',
      transportTitle: '计费连接失败',
      transportMessage: '计费请求在到达网关前失败',
      genericTitle: '计费请求失败',
      genericMessage: '计费请求失败'
    }
  },
  sendDiagnostics: {
    title: '向 Nous 发送诊断信息',
  ...
  settings: {
    ...
    memoryProvider: {
      loadFailed: detail => `记忆提供方设置加载失败：${detail}`,
      loadFailedFallback: '记忆提供方设置加载失败',
      loading: '正在加载记忆提供方设置…',
    ...
    gateway: {
      ...
      envOverride: '环境变量覆盖',
      intro:
        '默认使用本地网关，需控制远程机器或可信代理后的 Hermes 后端时，可改用远程网关，网关为本机级设置，profile 由所连网关发现',
    ...
    customEndpoints: {
      ...
      connectedNoModels: url => `连接到 ${url}, 但端点未声明任何模型`,
      defaultModelLabel: '默认模型',
      contextLabel: '模型 Token 限制',
      contextHint: '可分别设置每个模型的总上下文、最大输入和最大输出。任一项留空或清空都会恢复自动',
      modelLabel: '模型',
      ...
      test: '测试',
      newEndpoint: '新建端点',
      reachableVia: transport => `端点可以通过${transport}.`,
    ...
    providers: {
      ...
      providerDescriptions: {
        ...
        'DashScope (Qwen)': 'Alibaba Cloud DashScope — Qwen 与多家厂商模型',
        ...
        'Xiaomi MiMo': 'MiMo-V2.5 与Xiaomi自研模型',
    ...
    toolsets: {
      ...
      modelLabels: {
        'gpt-image-2-low': 'GPT Image 2（低）',
        'gpt-image-2-medium': 'GPT Image 2（中）',
        'gpt-image-2-high': 'GPT Image 2（高）',
        'gpt-image-2.5-flare': 'GPT Image 2.5 Flare（自动）',
        'gpt-image-2.5-flare-low': 'GPT Image 2.5 Flare（低）',
        'gpt-image-2.5-flare-medium': 'GPT Image 2.5 Flare（中）',
        'gpt-image-2.5-flare-high': 'GPT Image 2.5 Flare（高）',
        'gpt-image-2.5-flare-xhigh': 'GPT Image 2.5 Flare（超高）',
        'gpt-image-2.5-flare-max': 'GPT Image 2.5 Flare（最高）',
        'gpt-image-2.5-sunburst': 'GPT Image 2.5 Sunburst（自动）',
        'gpt-image-2.5-sunburst-low': 'GPT Image 2.5 Sunburst（低）',
        'gpt-image-2.5-sunburst-medium': 'GPT Image 2.5 Sunburst（中）',
        'gpt-image-2.5-sunburst-high': 'GPT Image 2.5 Sunburst（高）',
        'gpt-image-2.5-sunburst-xhigh': 'GPT Image 2.5 Sunburst（超高）',
        'gpt-image-2.5-sunburst-max': 'GPT Image 2.5 Sunburst（最高）',
        'minimax-h3-max': 'MiniMax H3 Max（FAL 后训练版）'
      },
      modelSpeeds: {
        Fast: '快速',
        Slower: '较慢',
      ...
      modelDescriptions: {
        ...
        'fal-ai/z-image/turbo': '中英双语，60 亿参数',
        'fal-ai/nano-banana-pro': 'Gemini 3 Pro，深度推理与文字渲染',
        'fal-ai/nano-banana-2': '快速推理、多语言文字与信息图',
        'fal-ai/gpt-image-1.5': '提示词遵循度高',
        'fal-ai/gpt-image-2': '顶尖文字渲染与中日韩文支持，具备世界知识的写实效果',
        'fal-ai/ideogram/v3': '出色的字体排版',
        'fal-ai/recraft/v4/pro/text-to-image': '设计与品牌系统，适合生产使用',
        'fal-ai/qwen-image': '基于大语言模型，擅长复杂文字',
        'fal-ai/krea/v2/medium/text-to-image': '插画、动漫、绘画及富有表现力的艺术风格',
        'fal-ai/krea/v2/large/text-to-image': '写实摄影与原始质感（运动模糊、颗粒、胶片）',
        'bytedance/seedream/v5/pro/text-to-image': '字节跳动旗舰模型，擅长密集布局，原生支持 14 种语言文字',
        'bytedance/seedream/v5/lite/text-to-image': '更快、更经济的 Seedream 档位，支持高分辨率输出',
        'ideogram/v4/instant': '最新 Ideogram 排版能力，适合海报与标志，可即时生成',
        'ideogram/v4/fast': '通过 rendering_speed 提供 Ideogram V4 多档质量',
        'alibaba/qwen-image-3/text-to-image': '复杂中英文字渲染，分辨率可由提示词控制',
        'microsoft/mai-image-2.5-pro': '微软旗舰模型，适合主视觉与精确排版',
        'google/nano-banana-2-lite': 'Gemini 图像系列，不到 2 秒，支持 14 种含极端比例的宽高比',
        ...
        'gpt-image-2.5-flare-high': '适合日常图像生成与编辑',
        'gpt-image-2.5-flare-xhigh': '适合日常图像生成与编辑',
        'gpt-image-2.5-flare-max': '适合日常图像生成与编辑',
        'gpt-image-2.5-sunburst': '适合精细图像生成与编辑',
        'gpt-image-2.5-sunburst-low': '适合精细图像生成与编辑',
        'gpt-image-2.5-sunburst-medium': '适合精细图像生成与编辑',
        ...
        'PrunaAI/p-image': '实时高保真图像生成，文字渲染、细节精度和提示词遵循表现出色，约 1 秒完成',
        'black-forest-labs/FLUX-1-dev':
          'Black Forest Labs 的 120 亿参数图像模型，擅长复杂提示词、精细画面以及手部与面部结构',
        'black-forest-labs/FLUX-2-pro': '多参考图像生成与编辑，细节、色彩精度和空间推理出色，可精确控制写实效果',
        'stabilityai/sdxl-turbo': 'Stability AI 的高速 SDXL 蒸馏模型，用较少步骤生成高质量图像',
        'google/nano-banana-2': '高质量图像生成与编辑，结合 Google 图片搜索增强长尾实体识别和视觉理解',
        'google/nano-banana-pro': '融合先进推理能力，适合复杂、多轮图像生成与编辑',
        'Qwen/Qwen-Image-Max': '减少生成图像的"AI 感"，提升人物材质、自然纹理与文字渲染的真实感和细节',
        'Wan-AI/Wan2.6-T2I': '升级画质、美感与指令遵循能力，支持精确风格控制、写实人像、长文本理解及广泛文化题材',
        'Bria/fibo_edit': '面向生产的开源图像编辑模型，原生蒙版，采用轻量 80 亿参数架构',
        'black-forest-labs/FLUX-2-klein-4b': 'FLUX 2 系列中速度最快的模型，支持先进的图像生成与编辑',
        'black-forest-labs/FLUX-2-max': 'Black Forest Labs 新一代顶级图像模型，显著提升图像质量与编辑一致性',
        'black-forest-labs/FLUX-2-dev': '采用更快、更模块化的架构，提升性能与控制能力，适合自定义推理工作流',
        'Bria/fibo': '开源、原生 JSON 的文生图模型，可通过详细结构化描述精细控制光线、构图与相机参数',
        ...
        'black-forest-labs/FLUX-1-Redux-dev':
          '适用于 FLUX.1 基础模型的图像变体适配器，支持轻微变体、文字驱动的重绘和高质量 400 万像素输出',
        'black-forest-labs/FLUX-1.1-pro':
          'Black Forest Labs 的先进专有模型，提示词遵循、画质、细节与输出多样性表现顶尖',
        'ByteDance/Seedance-1.5-Pro': '字节跳动专业视频模型，采用原生 V2A 生成，实现一体化、同步的音视频输出',
        'PrunaAI/p-video': '实时生成文本、图像与音频驱动的视频，最高支持 1080p 48 FPS、内置音频及 4 倍速预览模式',
        'Wan-AI/Wan2.2-T2V-A14B':
          '新一代 140 亿参数视频基础模型，采用两阶段去噪架构，可由文字提示生成连贯、清晰的 480p 视频',
        ...
        'Pixverse/Pixverse-T2V-HD': 'PixVerse 1080p 高保真模式，显著提升锐度、清晰度与细节，适合精致的专业项目',
        'Pixverse/Pixverse-T2V': 'PixVerse 720p 快速可靠模式，适合预览和社交媒体内容，优先保障生成速度',
        'google/veo-3.1-fast': 'Google 最新文生视频模型，可由简单提示词生成带同步音频的高保真电影级视频',
        'google/veo-3.1': 'Google 最新文生视频模型，可由简单提示词生成带同步音频的高保真电影级视频'
      },
      modelPrices: {
        'gpt-image-2-low': '价格因用量而异',
        'gpt-image-2-medium': '价格因用量而异',
        'gpt-image-2-high': '价格因用量而异',
        'fal-ai/flux-2/klein/9b': '$0.006/百万像素',
        'fal-ai/flux-2-pro': '$0.03/百万像素',
        'fal-ai/z-image/turbo': '$0.005/百万像素',
        'fal-ai/nano-banana-pro': '$0.15/张图（1K）',
        'fal-ai/nano-banana-2': '低成本 Flash 档位',
        'fal-ai/gpt-image-1.5': '$0.034/张图',
        'fal-ai/gpt-image-2': '$0.04–0.06/张图',
        'fal-ai/ideogram/v3': '$0.03–0.09/张图',
        'fal-ai/recraft/v4/pro/text-to-image': '$0.25/张图',
        'fal-ai/qwen-image': '$0.02/百万像素',
        'fal-ai/krea/v2/medium/text-to-image': '$0.030（文本）/ $0.035（风格参考）',
        'fal-ai/krea/v2/large/text-to-image': '$0.060（文本）/ $0.065（风格参考）',
        'bytedance/seedream/v5/pro/text-to-image': '$0.0675/张图（≤1536²）',
        'bytedance/seedream/v5/lite/text-to-image': '$0.035/张图',
        'ideogram/v4/instant': '$0.0075/百万像素',
        'ideogram/v4/fast': '$0.005–0.018/百万像素',
        'alibaba/qwen-image-3/text-to-image': '$0.04（1K）/ $0.075（2K）每张图',
        'microsoft/mai-image-2.5-pro': '~$0.17/张图',
        'google/nano-banana-2-lite': '~$0.04/张图（固定 1K）',
        'fal-ai/recraft/v4.1/text-to-image': '$0.035/张图',
        'openai/gpt-image-2.5/flare/text-to-image': '按 Token 计费',
        'openai/gpt-image-2.5/sunburst/text-to-image': '按 Token 计费',
        'xai/grok-imagine-image/v2.0/text-to-image': '$0.06/张图（1K，中等质量）',
        'gpt-image-2.5-flare': '价格因用量而异',
        'gpt-image-2.5-flare-low': '价格因用量而异',
        'gpt-image-2.5-flare-medium': '价格因用量而异',
        'gpt-image-2.5-flare-high': '价格因用量而异',
        'gpt-image-2.5-flare-xhigh': '价格因用量而异',
        'gpt-image-2.5-flare-max': '价格因用量而异',
        'gpt-image-2.5-sunburst': '价格因用量而异',
        'gpt-image-2.5-sunburst-low': '价格因用量而异',
        'gpt-image-2.5-sunburst-medium': '价格因用量而异',
        'gpt-image-2.5-sunburst-high': '价格因用量而异',
        'gpt-image-2.5-sunburst-xhigh': '价格因用量而异',
        'gpt-image-2.5-sunburst-max': '价格因用量而异',
        'krea-2-medium': '$0.030（文本）/ $0.035（风格参考）/ $0.040（情绪板）',
        'krea-2-large': '$0.060（文本）/ $0.065（风格参考）/ $0.070（情绪板）',
        'krea-2-medium-turbo': '$0.015（文本）/ $0.0175（风格参考）',
        'muse-image-1.0': '$0.01/张图',
        'ltx-2.3': '经济',
        'pixverse-v6': '经济',
        'seedance-2.0-mini': '经济',
        'veo3.1': '高级',
        'seedance-2.0': '高级',
        'seedance-2.5': '高级',
        'minimax-h3': '高级',
        ...
        'flux-3': '高级',
        'grok-imagine-1.5': '高级',
        'gemini-omni-flash': '高级',
        'kling-v3-4k': '高级',
        'happy-horse': '高级',
        'grok-imagine-video': '详见 https://docs.x.ai/developers/models/grok-imagine-video',
        'grok-imagine-video-1.5': '详见 https://docs.x.ai/developers/pricing',
        'black-forest-labs/FLUX-1-schnell': '$0.0005/张图',
        'black-forest-labs/FLUX-2-klein-9b': '$0.0150/张图',
        'PrunaAI/p-image': '$0.0050/张图',
        'black-forest-labs/FLUX-1-dev': '$0.0090/张图',
        'black-forest-labs/FLUX-2-pro': '$0.0150/张图',
        'stabilityai/sdxl-turbo': '$0.0002/张图',
        'Qwen/Qwen-Image-Max': '$0.0750/张图',
        'Wan-AI/Wan2.6-T2I': '$0.0300/张图',
        'Bria/fibo_edit': '$0.0400/张图',
        'black-forest-labs/FLUX-2-klein-4b': '$0.0140/张图',
        'black-forest-labs/FLUX-2-max': '$0.1000/张图',
        'black-forest-labs/FLUX-2-dev': '$0.0100/张图',
        'Bria/fibo': '$0.0400/张图',
        'ByteDance/Seedream-4': '$0.0400/张图',
        'Bria/Bria-3.2-vector': '$0.0400/张图',
        'Bria/Bria-3.2': '$0.0400/张图',
        'Bria/blur_background': '$0.0400/张图',
        'Bria/erase_foreground': '$0.0400/张图',
        'Bria/remove_background': '$0.0180/张图',
        'Bria/expand': '$0.0400/张图',
        'Qwen/Qwen-Image-Edit': '$0.0250/张图',
        'black-forest-labs/FLUX.1-Kontext-dev': '$0.0100/张图',
        'black-forest-labs/FLUX-1-Redux-dev': '$0.0120/张图',
        'black-forest-labs/FLUX-1.1-pro': '$0.0400/张图'
      },
      terminalBackend: {
        sectionTitle: '执行后端',
        loading: '正在检查执行后端…',
  ...
  skills: {
    collective: {
      ...
      viewSkill: '查看技能',
      markSeen: '全部标为已读',
      installationRefreshFailed: '刷新集体智慧安装状态失败',
      preparationFailed: '准备集体智慧贡献失败',
      installPlanningFailed: '制定集体智慧安装方案失败',
      setupFailed: '设置集体智慧失败',
      registryRefreshFailed: '刷新集体智慧目录失败',
      localScanFailed: '集体智慧本地扫描失败',
      updateCheckFailed: '检查集体智慧更新失败',
      acknowledgeNotificationsFailed: '无法将集体智慧通知标为已读',
      deferNotificationFailed: '无法暂缓集体智慧通知'
    },
    tabCollective: '集体智慧',
  ...
  starmap: {
    ...
    ageLegend: '核心 = 最早 · 外围 = 较新',
    editNode: kind => `编辑${kind === 'memory' ? '记忆' : '技能'}…`,
    archiveSkill: '归档技能',
    deleteMemory: '删除记忆',
  ...
  commandCenter: {
    ...
    generatePet: {
      ...
      unavailableTitle: '请先添加图片生成后端',
      unavailableDesc: '孵化自定义宠物需要能够使用参考图的提供方',
  ...
  messaging: {
    ...
    restartFailedManualDetail: '再次尝试重新启动; 如果它仍然失败, 打开日志并发送诊断 .',
    restartAgain: '再次重启',
    openLogs: '打开日志',
    platformDescription: {
      ...
      irc: '在 IRC 频道（或私信）与 Hermes 之间中继消息',
      line: '通过 LINE Messaging API Webhook 在 LINE 中使用 Hermes',
      teams: '通过 Bot Framework 把 Hermes 接入 Microsoft Teams 聊天',
  ...
  cron: {
    ...
    newCron: '新建定时任务',
    emptyDescNew: '使用 cron 表达式创建定时任务，Hermes 会运行提示词，并把结果发送到你选择的目的地',
    ...
    editTitle: '编辑定时任务',
    createTitle: '新建定时任务',
    editDesc: '更新定时计划、提示词或投递目标，更改将在下次运行时生效',
    createDesc: '创建定时任务以自动运行提示词，可使用 cron 语法或类似"每 15 分钟"的自然语言',
    nameLabel: '名称',
  ...
  composer: {
    ...
    voiceEngineLiveNeedsKey: '未配置 OpenAI API 密钥（请设置 OPENAI_API_KEY 或 voice.gpt_live.api_key）',
  ...
  shell: {
    ...
    statusbar: {
      ...
      toggleFreeTier: '免费套餐',
      toggleWorkspace: '工作区',
      cacheHitRateTitle: '本会话的提示缓存命中率',
      tokensPerSecondTitle: '每秒输出 Token 数，取最近 10 次模型调用平均值',
      agents: '代理',
      closeAgents: '关闭代理',
      openAgents: '打开代理',
      subagents: count => `${count} 个子代理`,
  ...
  assistant: {
    media: {
      gatewayFetchFailed: name => `无法从网关获取 ${name}（文件可能不存在、不可读或过大）`,
      openMediaFile: kind => `打开${kind === 'audio' ? '音频' : '视频'}文件`,
      openNamed: name => `打开 ${name}`,
      loadingNamed: name => `正在加载 ${name}…`,
      couldNotLoad: name => `无法加载 ${name}`,
      openImage: '打开图片',
    ...
    embeds: {
      ...
      failedToLoad: label => `无法加载 ${label} 嵌入内容`,
      openDiagram: '打开图表',
      embedTitle: label => `${label} 嵌入内容`
    },
    thread: {
      ...
      steered: '已引导',
      asyncDelegationFailure: detail => `（失败：${detail}）`,
      asyncDelegationPartialOutput: '部分输出：',
      messagingAgent: name => `正在向 ${name} 发送消息…`,
      messagedAgent: name => `已向 ${name} 发送消息`,
      ...
      reactedByHermes: 'Hermes 的回应',
      conversationTimeline: '对话时间线',
      reviewSummary: {
        label: '自我改进回顾',
        memoryUpdated: '记忆已更新',
        memoryCreated: '记忆条目已创建',
        userProfileUpdated: '用户资料已更新',
        skillCreated: '技能已创建',
        skillNamedCreated: (name, detail) => `技能"${name}"已创建${detail ? `：${detail}` : ''}`,
        skillNamedPatched: (name, detail) => `技能"${name}"已修补${detail ? `：${detail}` : ''}`,
        skillNamedRewritten: (name, detail) => `技能"${name}"已重写${detail ? `：${detail}` : ''}`,
        memoryLabel: '记忆',
        userProfileLabel: '用户资料'
      },
      ...
      errorLayers: {
        ...
        billing: '额度不足',
        disk: '磁盘已满',
        endpoint: '无法连接到您的模型服务器',
        gateway: 'Hermes 遇到问题',
        generic: 'Hermes 无法完成此回复',
        provider: 'AI 服务返回了一个错误',
        runtime: 'Hermes 遇到问题',
        streaming: '答复被切断了'
      },
      errorRetry: '重试',
      ...
      attachingFile: '正在附加…',
      errorLayerBodies: {
        auth: 'AI服务拒绝了你的登录。 检查此提供者的证书, 然后再次发送您的消息 .',
        billing: '你的账户没有这个供应商的信用 顶端或切换提供者,然后再次发送.',
        disk: '您的磁盘已经满了, 所以 Hermes 无法保存这个对话 。 腾出一些空间,然后重试.',
        endpoint: 'Hermes无法到达您的自定义模型服务器. 检查是否在运行, 然后再次发送您的消息 .',
        gateway: 'Hermes从这个答复开始出现内部问题。 再次发送您的信息; 如果它持续发生, 发送诊断.',
        generic: 'Hermes在回答时出事了 重试,或复制细节 如果它不断发生.',
        provider: 'AI服务无法完成此请求 。 立即重试或切换提供者 .',
        runtime: 'Hermes从这个答复开始出现内部问题。 再次发送您的信息; 如果它持续发生, 发送诊断.',
        streaming: '连接在回复完成前已中断 。 复试再寄.'
      },
      errorCodes: {
        auth: {
          title: provider => `${provider}拒绝了您的登录`,
          body: provider => `为${provider}保存的凭据未被接受。请在设置中修正，或切换提供商，然后再次发送您的消息。`
        },
        auth_permanent: {
          title: provider => `${provider}拒绝了您的登录`,
          body: provider => `为${provider}无效或已被撤销。请更新它们或更换提供商，然后再次发送您的消息。`
        },
        billing: {
          title: '余额不足',
          body: provider => `您的${provider}账户余额已用尽。请充值或更换提供商，然后再次发送。`
        },
        rate_limit: {
          title: '人工智能服务很忙',
          body: provider => `${provider}目前正在限制请求。请等待一分钟，然后重试。`
        },
        upstream_rate_limit: {
          title: '人工智能服务很忙',
          body: provider => `${provider}目前正在限制请求。请等待一分钟，然后重试。`
        ...
        overloaded: {
          title: 'AI服务超载了',
          body: provider => `${provider}目前出现问题。请稍后重试或更换提供商。`
        },
        server_error: {
          title: 'AI服务有问题',
        ...
        timeout: {
          title: '回复超时',
          body: provider => `${provider}未及时响应。请重试发送。`
        },
        stream_drop: {
          title: '答复被切断了',
          body: '连接在回复完成前已中断 。 复试再寄.'
        },
        upstream_blocked: {
          title: '防火墙屏蔽了请求',
          body: provider =>
            `防火墙或位于前面的 CDN}${provider}在请求到达模型之前被阻止——你的密钥可能没问题。在设置中通过提供者的 extra_headers 设置 User-Agent 头，或者切换提供者，然后再次发送你的消息。`
        },
        ssl_cert_verification: {
          title: '安全连接失败',
          body: provider =>
            `Hermes could not verify the secure connection to ${provider}。检查您的网络或代理服务器设置,或切换提供者,然后再次发送消息.`
        },
        context_overflow: {
          title: '谈话时间太长了',
          body: '谈话已经不适合模特儿了 压缩或启动新聊天,然后再次发送.'
        },
        payload_too_large: {
          title: '这个消息太大了',
          body: '申请对模型来说太大了 压缩对话或开始新的聊天,然后再次发送.'
        },
        model_not_found: {
          title: '此模式不可用',
          body: provider => `${provider}您的账户未提供此型号。请选择其他型号，然后再次发送您的消息。`
        },
        provider_policy_blocked: {
          title: '此模式被您的账户设置所屏蔽',
          body: provider => `${provider}不会在您账户的数据或隐私设置下处理此请求。请选择其他模型或切换提供商。`
        },
        content_policy_blocked: {
          title: 'AI服务拒绝了这一要求',
          body: provider => `${provider}不会回复此消息。请编辑后再次发送。`
        },
        format_error: {
          title: 'AI服务拒绝了这一请求',
          body: provider => `${provider}未能接受此请求的构建方式。请更换提供商或发送诊断信息，以便我们进行调查。`
        },
        truncated: {
          title: '答复被缩短了',
          body: '模型在完成前就停止了. 重试以获得完整回复 .'
        },
        invalid_response: {
          title: 'AI服务发送了无法读取的回复',
          body: provider => `${provider}返回了无法读取的 Hermes。请稍后重试。`
        },
        empty_response: {
          title: 'AI 服务发送空回复',
          body: provider => `${provider}此消息未返回任何内容。请稍后重试。`
        },
        loop_error: {
          title: 'Hermes 被困在循环中',
          body: '答复中不断重复同样的步骤,因此Hermes停止. 重试, 或者重新开始聊天 .'
        },
        SESSION_NOT_OWNED: {
          title: '这个聊天在别的地方开着',
          body: '此聊天目前在另一个 Hermes 窗口或终端打开 。 关闭它并再次发送您的消息, 或者在这里开始一个新的聊天 .'
        },
        disk_full: {
          title: '磁盘已满',
          body: '您的磁盘已经满了, 所以 Hermes 无法保存这个对话 。 腾出一些空间,然后重试.'
        },
        free_tier_disabled: {
          title: '使用Hermes 不签名就关机了',
          body: '签入Nous账户继续聊天,免费.'
        },
        free_tier_rate_limited: {
          title: '你用光了闲聊的零用钱,不用签了',
          body: '很快会恢复活力的 签一个Nous帐户 给更多的津贴,这是免费的.'
        },
        free_tier_at_capacity: {
          title: '闲聊不签,现在真的很忙',
          body: '签名跳过队列,是免费的,或过一会儿再试一次.'
        },
        free_tier_model_not_free: {
          title: '这个模型没有签字就不行',
          body: 'Hermes目前使用免费型号. 用Nous账户签入更多型号,是免费的.'
        },
        free_tier_route: {
          title: 'Hermes 无法到达这条路线上的免费模型',
          body: '用 Nous 账户签名,是免费的,或者检查 NOUS_INFERENCE_BASE_URL 设置.'
        },
        free_tier_outage: {
          title: '免费模特儿现在反应有问题',
          body: '一分钟后再发送一次消息.'
        ...
        free_tier_refused: {
          title: 'Hermes没有签字无法发送',
          body: '用 Nous 账户签名是免费的.'
        }
      },
      errorAuthKinds: {
        api_key: {
      ...
      errorDetails: '详情',
      errorGenericProvider: '人工智能服务',
      errorToastTitle: 'Hermes无法完成答复',
      errorLimitResets: time => `限制重置于${time}`,
      errorRetryAtReset: time => `在限制重置时重试 (${time})`,
      errorRetryScheduled: (time, wait) => `重试于${time}— 在${wait}`,
      errorRetryScheduledCancel: '取消',
      errorChooseModel: '选择一个模型',
    ...
    tool: {
      ...
      skillActivity: {
        ...
        loaded: '已加载技能',
        loadFailed: '加载技能失败',
        readingResource: '阅读技能资源',
        readResource: '阅读技能资源',
        resourceFailed: '读取技能资源失败',
        listing: '列出技能',
        listed: '列出的技能',
        listFailed: '未能列出技能',
        unavailable: '技能结果不可用'
  ...
  desktop: {
    ...
    logUnavailable: detail => `日志不可用：${detail}`,
