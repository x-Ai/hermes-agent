...
export const zh: Translations = {
  ...
  settings: {
    ...
    envKeys: {
      ...
      DASHSCOPE_API_KEY: { description: 'Alibaba Cloud百炼 DashScope API 密钥（Qwen 及多提供方模型）' },
      ...
      XIAOMI_API_KEY: { description: 'Xiaomi MiMo API 密钥（用于 mimo-v2.5-pro、mimo-v2.5 等 MiMo 模型）' },
      XIAOMI_BASE_URL: { description: 'Xiaomi MiMo 基础 URL 覆盖（默认 https://api.xiaomimimo.com/v1）' },
      ...
      ALIBABA_TOKEN_PLAN_API_KEY: { description: 'Alibaba Cloud（Token Plan）API 密钥' },
      ALIBABA_TOKEN_PLAN_BASE_URL: { description: 'Alibaba Cloud（Token Plan）基础 URL 覆盖' },
      ALIBABA_TOKEN_PLAN_CN_API_KEY: { description: 'Alibaba Cloud（Token Plan，中国大陆）API 密钥' },
      ALIBABA_TOKEN_PLAN_CN_BASE_URL: { description: 'Alibaba Cloud（Token Plan，中国大陆）基础 URL 覆盖' },
      ALIBABA_CODING_PLAN_API_KEY: { description: 'Alibaba Cloud（Coding Plan）API 密钥' },
      ALIBABA_CODING_PLAN_BASE_URL: { description: 'Alibaba Cloud（Coding Plan）基础 URL 覆盖' },
      ALIBABA_CODING_PLAN_CN_API_KEY: { description: 'Alibaba Cloud（Coding Plan，中国大陆）API 密钥' },
      ALIBABA_CODING_PLAN_CN_BASE_URL: { description: 'Alibaba Cloud（Coding Plan，中国大陆）基础 URL 覆盖' },
