...
export const ru = defineLocale({
  ...
  introReveal: {
    ...
    tools: {
      blender: { label: 'blender-mcp', running: 'подключаемся к Blender…', done: 'сцена подключена' },
      metal: { label: 'металл', running: 'собираем металл…', done: 'металл · шерох. 0,2' },
      glass: { label: 'стекло', running: 'собираем стекло…', done: 'стекло · IOR 1,45' }
    },
    sideAgents: {
      research: {
  ...
  guidedOnboarding: {
    ...
    layoutNames: { basic: 'Базовая', elite: 'Расширенная' },
    script: {
  ...
  desktop: {
    ...
    poolSlotTimeoutBody:
      'Все слоты локальных бэкендов профилей заняты. Увеличьте «Число работающих бэкендов ботов» в «Настройки» → «Дополнительно» или повторите попытку после освобождения неактивного бэкенда.',
