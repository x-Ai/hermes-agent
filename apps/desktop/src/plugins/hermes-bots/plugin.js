    ...
    children: [
      ...
      jsxs(ContextMenuContent, {
        children: [
          jsx(ContextMenuItem, {
            onSelect: () => {
              void ensureBotMetadata(bot).then(current => {
                ...
                host.notify({
                  kind: 'info',
                  message: b.pinned(displayName(bot, current), !pinned)
                })
              }).catch(error => host.notifyError?.(error, b.couldNotLoad))
            },
          ...
          jsx(ContextMenuItem, {
            onSelect: () => {
              void ensureBotMetadata(bot).then(current => {
                ...
                host.notify({
                  kind: 'info',
                  message: hidden ? b.botUnhidden(displayName(bot, current)) : b.botHidden(displayName(bot, current))
                })
              }).catch(error => host.notifyError?.(error, b.couldNotLoad))
            },
          ...
          jsx(ContextMenuItem, {
            onSelect: () => void ensureBotMetadata(bot).then(() => onEdit(bot)).catch(error => host.notifyError?.(error, b.couldNotLoad)),
            children: b.editProfile
          }),
          jsx(ContextMenuItem, {
            onSelect: () => void ensureBotMetadata(bot).then(() => onGroup(bot)).catch(error => host.notifyError?.(error, b.couldNotLoad)),
      ...
      children: [
        jsxs(DialogHeader, {
          children: [
            ...
            jsx(DialogDescription, {
              children: b.recurringTaskDesc(
                displayName(typeof bot === 'string' ? { name: bot } : bot, botRosterMeta(bot, $botMeta.get()))
              )
            })
          ]
        }),
...
function GroupDialog({ bot, onClose }) {
  ...
  const setMembership = (group, enabled) => {
    ...
    host.notify({
      ...
      message: enabled
        ? b.addedToGroup(displayName(bot, botRosterMeta(bot, meta)), group)
        : b.removedFromNamedGroup(displayName(bot, botRosterMeta(bot, meta)), group)
    })
  }
