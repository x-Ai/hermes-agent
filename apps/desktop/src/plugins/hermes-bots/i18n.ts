...
const zh: BotsMessages = {
  roster: {
    ...
    attentionBlocked: '机器人已阻塞 — 请查看它的最后一条消息',
    groupChats: '群聊',
    emptyTitle: '还没有机器人',
  ...
  bot: {
    ...
    draftDiscarded: name => `已丢弃机器人草稿“${name}”`,
    couldNotCleanDraft: name => `无法清理草稿配置档案“${name}”`,
    createOn: '创建位置',
    currentConnection: name => `${name}（当前）`,
    remoteLocation: target => `机器人将在 ${target} 上创建，并作为连接机器人显示在名单中；聊天会路由到该设备`,
    tabGeneral: '常规',
    tabCapabilities: '能力',
    tabSkills: '技能',
    tabTools: '工具',
    ...
    nameFirstForCapabilities: '请先为机器人命名；打开此标签时会创建草稿配置档案（取消时将删除）',
    ...
    unhide: '取消隐藏',
    hiddenChanged: (name, hidden) =>
      hidden ? `${name} 已隐藏 — 可使用机器人标题栏中的眼睛按钮查看隐藏的机器人` : `${name} 已重新显示在名单中`,
    ...
    deleteDescription: (name, path) =>
      path
        ? `这将永久删除机器人 ${name} 及其位于 ${path} 的关联 Hermes 配置档案，此操作无法撤销`
        : `这将永久删除机器人 ${name} 及其关联 Hermes 配置档案，此操作无法撤销`,
    deleting: '删除中…',
    deleted: '已删除',
    ...
    updateGatewayTitle: '请更新此网关以使用机器人模式',
    updateGatewayMessage: gateway => `请更新${gateway}，然后重试。`,
    workspaceSelectionRequired: '请先选择一个机器人或群聊。',
    chatEmpty: '说点什么开始吧。',
    chatNeverResetsTitle: '此聊天永不重置',
    chatNeverResetsMessage: '机器人聊天是一段连续对话，因此会改为压缩。如需与此机器人进行临时会话，请使用会话模式',
    kickoff: '你好，介绍一下你自己吧！'
  },
  avatar: {
    auto: '自动',
    autoTitle: '自动 — 由机器人名称决定',
...
const zhHant: BotsMessages = {
  roster: {
    ...
    attentionBlocked: '機器人已阻塞 — 請查看它的最後一則訊息',
    groupChats: '群組聊天',
    emptyTitle: '還沒有機器人',
  ...
  bot: {
    ...
    draftDiscarded: name => `已捨棄機器人草稿「${name}」`,
    couldNotCleanDraft: name => `無法清理草稿設定檔「${name}」`,
    createOn: '建立位置',
    currentConnection: name => `${name}（目前）`,
    remoteLocation: target => `機器人將在 ${target} 上建立，並作為連線機器人顯示在名單中；聊天會路由到該裝置。`,
    tabGeneral: '一般',
    tabCapabilities: '功能',
    tabSkills: '技能',
    tabTools: '工具',
    ...
    nameFirstForCapabilities: '請先為機器人命名；開啟此分頁時會建立草稿設定檔（取消時將刪除）。',
    ...
    unhide: '取消隱藏',
    hiddenChanged: (name, hidden) =>
      hidden ? `${name} 已隱藏 — 可使用機器人標題列中的眼睛按鈕查看隱藏的機器人` : `${name} 已重新顯示在名單中`,
    ...
    deleteDescription: (name, path) =>
      path
        ? `這將永久刪除機器人 ${name} 及其位於 ${path} 的關聯 Hermes 設定檔，此操作無法復原。`
        : `這將永久刪除機器人 ${name} 及其關聯 Hermes 設定檔，此操作無法復原。`,
    deleting: '刪除中…',
    deleted: '已刪除',
    ...
    updateGatewayTitle: '請更新此閘道以使用機器人模式',
    updateGatewayMessage: gateway => `請更新${gateway}，然後重試。`,
    workspaceSelectionRequired: '請先選擇一個機器人或群組聊天。',
    chatEmpty: '說點什麼開始吧。',
    chatNeverResetsTitle: '此聊天永不重設',
    chatNeverResetsMessage:
      '機器人聊天是一段連續對話，因此會改為壓縮。如需與此機器人進行臨時工作階段，請使用工作階段模式。',
    kickoff: '你好，介紹一下你自己吧！'
  },
  avatar: {
    auto: '自動',
    autoTitle: '自動 — 由機器人名稱決定',
  ...
  group: {
    ...
    groupCreated: (name, count) => `已建立「${name}」，包含 ${count} 個機器人`,
    addedToGroup: (bot, group) => `${bot} 已加入「${group}」`,
    removedFromGroup: (bot, group) => `${bot} 已從「${group}」中移除`,
    openGroupChat: '開啟群組聊天',
    noBotsInGroup: '此群組聊天中沒有機器人',
