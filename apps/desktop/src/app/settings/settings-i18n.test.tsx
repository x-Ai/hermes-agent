...
const SHARED_LABEL_GAPS = [
  ...
  'agent.postToolEmptyRetries',
  'agent.thinkingPrefillRetries',
  'agent.emptyResponseRetries',
  'terminal.dockerMountCwdToWorkspace',
  'terminal.dockerWorkspacePerSession',
  'terminal.dockerWorkspaceMountPath',
  'terminal.singularityMountCwdToWorkspace',
  'terminal.singularityWorkspacePerSession',
  'terminal.singularityWorkspaceMountPath',
  'delegation.useCustomEndpoints',
  'voice.clientDirect',
  'stt.echoTranscripts',
  'tts.deepinfra.model',
  'tts.deepinfra.voice'
