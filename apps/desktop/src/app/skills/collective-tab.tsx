...
export function CollectiveTab({ profile, query }: { profile: ProfileScope; query: string }) {
  ...
  useEffect(() => {
    ...
    void refetchInstallations().catch(error => notifyError(error, copy.installationRefreshFailed))
  }, [copy.installationRefreshFailed, refetchInstallations, updateCheck.dataUpdatedAt])
  ...
  const prepare = async (candidate: WisdomCandidate) => {
    ...
    try {
      ...
      notifyError(error, copy.preparationFailed)
    } finally {
      setBusy(null)
    }
  }
  ...
  const planReferencedInstall = async () => {
    ...
    try {
      ...
      notifyError(error, copy.installPlanningFailed)
    } finally {
      setBusy(null)
    }
  }
  ...
  const setupProfile = async () => {
    ...
    try {
      ...
      notifyError(error, copy.setupFailed)
    } finally {
      setBusy(null)
    }
  }
            ...
            <Button
              onClick={async () => {
                ...
                try {
                  ...
                  notifyError(error, copy.registryRefreshFailed)
                } finally {
                  setBusy(null)
                }
              }}
            ...
            <Button
              onClick={async () => {
                ...
                try {
                  ...
                  notifyError(error, copy.localScanFailed)
                } finally {
                  setBusy(null)
                }
              }}
            ...
            <Button
              onClick={async () => {
                ...
                try {
                  ...
                  notifyError(error, copy.updateCheckFailed)
                } finally {
                  setBusy(null)
                }
              }}
